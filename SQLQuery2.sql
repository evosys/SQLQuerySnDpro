...
(select sbd.distributor,sbd.WORKING_DATE,sbd.WAREHOUSE, sbd.SKU ,
	...
	where sbd.WORKING_DATE in ('20170930','20171001') and b.PRICE_STRUC ='0001' and b.SELL_FACTOR1 <> '0'
) x	
join (
...
(
	...
	join batch b on b.sku = sbd.sku
	where sbd.WORKING_DATE in ('20170930','20171001') and ps.price_struc = '0001' 
) fix

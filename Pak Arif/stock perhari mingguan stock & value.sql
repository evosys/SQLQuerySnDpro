...
select co.COMP2_DESC RSM,co.COMP3_DESC AREA, x.DISTRIBUTOR,d.name,x.WORKING_DATE,wh.LDESC WAREHOUSE,wh.warehouse_type ,x.SKU,sk.ldesc NAMA_SKU,x.sku_type,
...
(select sbd.distributor,sbd.WORKING_DATE,sbd.WAREHOUSE, sbd.SKU ,
	...
	where sbd.WORKING_DATE in ('20180804','20180805') and b.PRICE_STRUC ='0001' and b.SELL_FACTOR1 <> '0'
) x	
--- start comp code
join (
...
(
	...
	join batch b on b.sku = sbd.sku
	where sbd.WORKING_DATE in ('20180804','20180805') and ps.price_struc = '0001'
) fix
where fix.value <> 0
...
where WORKING_DATE in ('20180804','20180805')
**/ 
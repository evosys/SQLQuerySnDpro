...
case when ftcm.first_trans < DATEADD(DAY, -83, '20190818') then 13
when ftcm.first_trans between DATEADD(DAY, -83, '20190818') and DATEADD(DAY, -77, '20190818') then 12
when ftcm.first_trans between DATEADD(DAY, -76, '20190818') and DATEADD(DAY, -70, '20190818') then 11
when ftcm.first_trans between DATEADD(DAY, -69, '20190818') and DATEADD(DAY, -63, '20190818') then 10
when ftcm.first_trans between DATEADD(DAY, -62, '20190818') and DATEADD(DAY, -56, '20190818') then 9
when ftcm.first_trans between DATEADD(DAY, -55, '20190818') and DATEADD(DAY, -49, '20190818') then 8
when ftcm.first_trans between DATEADD(DAY, -48, '20190818') and DATEADD(DAY, -42, '20190818') then 7
when ftcm.first_trans between DATEADD(DAY, -41, '20190818') and DATEADD(DAY, -35, '20190818') then 6
when ftcm.first_trans between DATEADD(DAY, -34, '20190818') and DATEADD(DAY, -28, '20190818') then 5
when ftcm.first_trans between DATEADD(DAY, -27, '20190818') and DATEADD(DAY, -21, '20190818') then 4
when ftcm.first_trans between DATEADD(DAY, -20, '20190818') and DATEADD(DAY, -14, '20190818') then 3
when ftcm.first_trans between DATEADD(DAY, -13, '20190818') and DATEADD(DAY, -7 , '20190818') then 2
when ftcm.first_trans > DATEADD(DAY, -7, '20190818') then 1
end pembagi,
GSV.GSV as 'GSV RPP',
GSV.GSV /
case when ftcm.first_trans < DATEADD(DAY, -83, '20190818') then 13
...
from cashmemo cm 
where cm.VISIT_TYPE = '02' and cm.DOC_DATE between '20190520' and '20190818'
group by cm.distributor,cm.town+cm.locality+cm.slocality+cm.pop 
